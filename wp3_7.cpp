...
std::shared_ptr<PatientHistory> Wp3_7::patientHistory()
{
    return m_patientHistory;
}

void Wp3_7::setPatientHistory(std::shared_ptr<PatientHistory> &patientHistory)
{
    m_patientHistory = patientHistory;
    patientHistory->setPatientClass(PgGlobalConstants::WP_3_7,Wp3_7::Patient_Class);
}
